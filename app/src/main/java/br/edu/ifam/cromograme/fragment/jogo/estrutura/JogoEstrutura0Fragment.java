...
public class JogoEstrutura0Fragment extends Fragment {
    ...
    private boolean acertou() {
        if (imgCar_01.getDrawable().equals(R.drawable.car_01)
                && imgCar_02.getDrawable().equals(R.drawable.car_02)
                && imgCar_03.getDrawable().equals(R.drawable.car_03)
                && imgCar_04.getDrawable().equals(R.drawable.car_04)
                && imgCar_05.getDrawable().equals(R.drawable.car_05)
                && imgCar_06.getDrawable().equals(R.drawable.car_06)
                && imgCar_07.getDrawable().equals(R.drawable.car_07)
                && imgCar_08.getDrawable().equals(R.drawable.car_08)
                && imgCar_09.getDrawable().equals(R.drawable.car_09)
                && imgCar_10.getDrawable().equals(R.drawable.car_10)
                && imgCar_11.getDrawable().equals(R.drawable.car_11)
                && imgCar_12.getDrawable().equals(R.drawable.car_12)
                && imgCar_13.getDrawable().equals(R.drawable.car_13)
                && imgCar_14.getDrawable().equals(R.drawable.car_14)
                && imgCar_15.getDrawable().equals(R.drawable.car_15)
                && imgCar_16.getDrawable().equals(R.drawable.car_16)
                && imgCar_17.getDrawable().equals(R.drawable.car_17)
                && imgCar_18.getDrawable().equals(R.drawable.car_18)
                && imgCar_19.getDrawable().equals(R.drawable.car_19)
                && imgCar_20.getDrawable().equals(R.drawable.car_20)
                && imgCar_21.getDrawable().equals(R.drawable.car_21)
                && imgCar_22.getDrawable().equals(R.drawable.car_22)
                && imgCar_23.getDrawable().equals(R.drawable.car_23)
                && imgCar_24.getDrawable().equals(R.drawable.car_24)) return true;
        else return false;
    }
