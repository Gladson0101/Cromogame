 ...
 */
public class DivCelNivel9Fragment extends Fragment {


    public DivCelNivel9Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_div_cel_nivel9, container, false);

        TextView textView = getActivity().findViewById(R.id.textViewQuestaoDivisaoCelular);
        textView.setText("Questão: 9/10");

        radioButton = view.findViewById(R.id.rbDivCerto9);
