...
public class JogoDoencas4Fragment extends Fragment {
    ...
    private boolean acertou() {
        if (imgEd_01.getDrawable().equals(R.drawable.ed_01)
                && imgEd_02.getDrawable().equals(R.drawable.ed_02)
                && imgEd_03.getDrawable().equals(R.drawable.ed_03)
                && imgEd_04.getDrawable().equals(R.drawable.ed_04)
                && imgEd_05.getDrawable().equals(R.drawable.ed_05)
                && imgEd_06.getDrawable().equals(R.drawable.ed_06)
                && imgEd_07.getDrawable().equals(R.drawable.ed_07)
                && imgEd_08.getDrawable().equals(R.drawable.ed_08)
                && imgEd_09.getDrawable().equals(R.drawable.ed_09)
                && imgEd_10.getDrawable().equals(R.drawable.ed_10)
                && imgEd_11.getDrawable().equals(R.drawable.ed_11)
                && imgEd_12.getDrawable().equals(R.drawable.ed_12)
                && imgEd_13.getDrawable().equals(R.drawable.ed_13)
                && imgEd_14.getDrawable().equals(R.drawable.ed_14)
                && imgEd_15.getDrawable().equals(R.drawable.ed_15)
                && imgEd_16.getDrawable().equals(R.drawable.ed_16)
                && imgEd_17.getDrawable().equals(R.drawable.ed_17)
                && imgEd_18.getDrawable().equals(R.drawable.ed_18)
                && imgEd_19.getDrawable().equals(R.drawable.ed_19)
                && imgEd_20.getDrawable().equals(R.drawable.ed_20)
                && imgEd_21.getDrawable().equals(R.drawable.ed_21)
                && imgEd_22.getDrawable().equals(R.drawable.ed_22)
                && imgEd_23.getDrawable().equals(R.drawable.ed_23)
                && imgEd_24.getDrawable().equals(R.drawable.ed_24)) return true;
        else return false;
    }
