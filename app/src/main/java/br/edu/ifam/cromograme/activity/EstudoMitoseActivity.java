...
public class EstudoMitoseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estudo_mitose);
        ...
        viewPager = findViewById(R.id.viewPagerEstudoMitose);
        ...
        buttonAnterior = findViewById(R.id.buttonEstudoMitoseAnterior);
        ...
        buttonProximo = findViewById(R.id.buttonEstudoMitoseProximo);
