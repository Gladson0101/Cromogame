 ...
 */
public class DivCelNivel5Fragment extends Fragment {


    public DivCelNivel5Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_div_cel_nivel5, container, false);

        TextView textView = getActivity().findViewById(R.id.textViewQuestaoDivisaoCelular);
        textView.setText("Questão: 5/10");

        radioButton = view.findViewById(R.id.rbDivCerto5);
