...
public class JogoDoencas13Fragment extends Fragment {
    ...
    private boolean acertou() {
        if (imgTri9_01.getDrawable().equals(R.drawable.tri9_01)
                && imgTri9_02.getDrawable().equals(R.drawable.tri9_02)
                && imgTri9_03.getDrawable().equals(R.drawable.tri9_03)
                && imgTri9_04.getDrawable().equals(R.drawable.tri9_04)
                && imgTri9_05.getDrawable().equals(R.drawable.tri9_05)
                && imgTri9_06.getDrawable().equals(R.drawable.tri9_06)
                && imgTri9_07.getDrawable().equals(R.drawable.tri9_07)
                && imgTri9_08.getDrawable().equals(R.drawable.tri9_08)
                && imgTri9_09.getDrawable().equals(R.drawable.tri9_09)
                && imgTri9_10.getDrawable().equals(R.drawable.tri9_10)
                && imgTri9_11.getDrawable().equals(R.drawable.tri9_11)
                && imgTri9_12.getDrawable().equals(R.drawable.tri9_12)
                && imgTri9_13.getDrawable().equals(R.drawable.tri9_13)
                && imgTri9_14.getDrawable().equals(R.drawable.tri9_14)
                && imgTri9_15.getDrawable().equals(R.drawable.tri9_15)
                && imgTri9_16.getDrawable().equals(R.drawable.tri9_16)
                && imgTri9_17.getDrawable().equals(R.drawable.tri9_17)
                && imgTri9_18.getDrawable().equals(R.drawable.tri9_18)
                && imgTri9_19.getDrawable().equals(R.drawable.tri9_19)
                && imgTri9_20.getDrawable().equals(R.drawable.tri9_20)
                && imgTri9_21.getDrawable().equals(R.drawable.tri9_21)
                && imgTri9_22.getDrawable().equals(R.drawable.tri9_22)
                && imgTri9_23.getDrawable().equals(R.drawable.tri9_23)
                && imgTri9_24.getDrawable().equals(R.drawable.tri9_24)) return true;
        else return false;
    }
