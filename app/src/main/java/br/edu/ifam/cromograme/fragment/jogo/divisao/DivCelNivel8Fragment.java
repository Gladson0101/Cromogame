 ...
 */
public class DivCelNivel8Fragment extends Fragment {


    public DivCelNivel8Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_div_cel_nivel8, container, false);

        TextView textView = getActivity().findViewById(R.id.textViewQuestaoDivisaoCelular);
        textView.setText("Questão: 8/10");

        radioButton = view.findViewById(R.id.rbDivCerto8);
