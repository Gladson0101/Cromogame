...
public class JogoDoencas7Fragment extends Fragment {
    ...
    private boolean acertou() {
        if (imgKli_01.getDrawable().equals(R.drawable.kli_01)
                && imgKli_02.getDrawable().equals(R.drawable.kli_02)
                && imgKli_03.getDrawable().equals(R.drawable.kli_03)
                && imgKli_04.getDrawable().equals(R.drawable.kli_04)
                && imgKli_05.getDrawable().equals(R.drawable.kli_05)
                && imgKli_06.getDrawable().equals(R.drawable.kli_06)
                && imgKli_07.getDrawable().equals(R.drawable.kli_07)
                && imgKli_08.getDrawable().equals(R.drawable.kli_08)
                && imgKli_09.getDrawable().equals(R.drawable.kli_09)
                && imgKli_10.getDrawable().equals(R.drawable.kli_10)
                && imgKli_11.getDrawable().equals(R.drawable.kli_11)
                && imgKli_12.getDrawable().equals(R.drawable.kli_12)
                && imgKli_13.getDrawable().equals(R.drawable.kli_13)
                && imgKli_14.getDrawable().equals(R.drawable.kli_14)
                && imgKli_15.getDrawable().equals(R.drawable.kli_15)
                && imgKli_16.getDrawable().equals(R.drawable.kli_16)
                && imgKli_17.getDrawable().equals(R.drawable.kli_17)
                && imgKli_18.getDrawable().equals(R.drawable.kli_18)
                && imgKli_19.getDrawable().equals(R.drawable.kli_19)
                && imgKli_20.getDrawable().equals(R.drawable.kli_20)
                && imgKli_21.getDrawable().equals(R.drawable.kli_21)
                && imgKli_22.getDrawable().equals(R.drawable.kli_22)
                && imgKli_23.getDrawable().equals(R.drawable.kli_23)
                && imgKli_24.getDrawable().equals(R.drawable.kli_24)) return true;
        else return false;
    }
