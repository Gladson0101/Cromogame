 ...
 */
public class DivCelNivel2Fragment extends Fragment {


    public DivCelNivel2Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_div_cel_nivel2, container, false);

        TextView textView = getActivity().findViewById(R.id.textViewQuestaoDivisaoCelular);
        textView.setText("Questão: 2/10");

        radioButton = view.findViewById(R.id.rbDivCerto2);
