...
public class JogoDoencas11Fragment extends Fragment {
    ...
    private boolean acertou() {
        if (imgOlho_01.getDrawable().equals(R.drawable.olho_01)
                && imgOlho_02.getDrawable().equals(R.drawable.olho_02)
                && imgOlho_03.getDrawable().equals(R.drawable.olho_03)
                && imgOlho_04.getDrawable().equals(R.drawable.olho_04)
                && imgOlho_05.getDrawable().equals(R.drawable.olho_05)
                && imgOlho_06.getDrawable().equals(R.drawable.olho_06)
                && imgOlho_07.getDrawable().equals(R.drawable.olho_07)
                && imgOlho_08.getDrawable().equals(R.drawable.olho_08)
                && imgOlho_09.getDrawable().equals(R.drawable.olho_09)
                && imgOlho_10.getDrawable().equals(R.drawable.olho_10)
                && imgOlho_11.getDrawable().equals(R.drawable.olho_11)
                && imgOlho_12.getDrawable().equals(R.drawable.olho_12)
                && imgOlho_13.getDrawable().equals(R.drawable.olho_13)
                && imgOlho_14.getDrawable().equals(R.drawable.olho_14)
                && imgOlho_15.getDrawable().equals(R.drawable.olho_15)
                && imgOlho_16.getDrawable().equals(R.drawable.olho_16)
                && imgOlho_17.getDrawable().equals(R.drawable.olho_17)
                && imgOlho_18.getDrawable().equals(R.drawable.olho_18)
                && imgOlho_19.getDrawable().equals(R.drawable.olho_19)
                && imgOlho_20.getDrawable().equals(R.drawable.olho_20)
                && imgOlho_21.getDrawable().equals(R.drawable.olho_21)
                && imgOlho_22.getDrawable().equals(R.drawable.olho_22)
                && imgOlho_23.getDrawable().equals(R.drawable.olho_23)
                && imgOlho_24.getDrawable().equals(R.drawable.olho_24)) return true;
        else return false;
    }
