 ...
 */
public class DivCelNivel7Fragment extends Fragment {


    public DivCelNivel7Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_div_cel_nivel7, container, false);

        TextView textView = getActivity().findViewById(R.id.textViewQuestaoDivisaoCelular);
        textView.setText("Questão: 7/10");
        radioButton = view.findViewById(R.id.rbDivCerto7);
