...
public class JogoDoencas12Fragment extends Fragment {
    ...
    private boolean acertou() {
        if (imgWar_01.getDrawable().equals(R.drawable.wark_01)
                && imgWar_02.getDrawable().equals(R.drawable.wark_02)
                && imgWar_03.getDrawable().equals(R.drawable.wark_03)
                && imgWar_04.getDrawable().equals(R.drawable.wark_04)
                && imgWar_05.getDrawable().equals(R.drawable.wark_05)
                && imgWar_06.getDrawable().equals(R.drawable.wark_06)
                && imgWar_07.getDrawable().equals(R.drawable.wark_07)
                && imgWar_08.getDrawable().equals(R.drawable.wark_08)
                && imgWar_09.getDrawable().equals(R.drawable.wark_09)
                && imgWar_10.getDrawable().equals(R.drawable.wark_10)
                && imgWar_11.getDrawable().equals(R.drawable.wark_11)
                && imgWar_12.getDrawable().equals(R.drawable.wark_12)
                && imgWar_13.getDrawable().equals(R.drawable.wark_13)
                && imgWar_14.getDrawable().equals(R.drawable.wark_14)
                && imgWar_15.getDrawable().equals(R.drawable.wark_15)
                && imgWar_16.getDrawable().equals(R.drawable.wark_16)
                && imgWar_17.getDrawable().equals(R.drawable.wark_17)
                && imgWar_18.getDrawable().equals(R.drawable.wark_18)
                && imgWar_19.getDrawable().equals(R.drawable.wark_19)
                && imgWar_20.getDrawable().equals(R.drawable.wark_20)
                && imgWar_21.getDrawable().equals(R.drawable.wark_21)
                && imgWar_22.getDrawable().equals(R.drawable.wark_22)
                && imgWar_23.getDrawable().equals(R.drawable.wark_23)
                && imgWar_24.getDrawable().equals(R.drawable.wark_24)) return true;
        else return false;
    }
