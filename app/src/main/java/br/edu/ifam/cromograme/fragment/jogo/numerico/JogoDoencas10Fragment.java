...
public class JogoDoencas10Fragment extends Fragment {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (acertou() && !hasClickers()) {
                    ...
                    imgResposta.setImageResource(R.drawable.down);
                    ...
                    builder.setPositiveButton("Próximo", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            transaction.replace(R.id.frameLayoutJogoDoencas, new JogoDoencas11Fragment());
                            transaction.commit();
                        }
                    });
                    builder.create().show();
    ...
    private boolean acertou() {
        if (imgDown_01.getDrawable().equals(R.drawable.down_01)
                && imgDown_02.getDrawable().equals(R.drawable.down_02)
                && imgDown_03.getDrawable().equals(R.drawable.down_03)
                && imgDown_04.getDrawable().equals(R.drawable.down_04)
                && imgDown_05.getDrawable().equals(R.drawable.down_05)
                && imgDown_06.getDrawable().equals(R.drawable.down_06)
                && imgDown_07.getDrawable().equals(R.drawable.down_07)
                && imgDown_08.getDrawable().equals(R.drawable.down_08)
                && imgDown_09.getDrawable().equals(R.drawable.down_09)
                && imgDown_10.getDrawable().equals(R.drawable.down_10)
                && imgDown_11.getDrawable().equals(R.drawable.down_11)
                && imgDown_12.getDrawable().equals(R.drawable.down_12)
                && imgDown_13.getDrawable().equals(R.drawable.down_13)
                && imgDown_14.getDrawable().equals(R.drawable.down_14)
                && imgDown_15.getDrawable().equals(R.drawable.down_15)
                && imgDown_16.getDrawable().equals(R.drawable.down_16)
                && imgDown_17.getDrawable().equals(R.drawable.down_17)
                && imgDown_18.getDrawable().equals(R.drawable.down_18)
                && imgDown_19.getDrawable().equals(R.drawable.down_19)
                && imgDown_20.getDrawable().equals(R.drawable.down_20)
                && imgDown_21.getDrawable().equals(R.drawable.down_21)
                && imgDown_22.getDrawable().equals(R.drawable.down_22)
                && imgDown_23.getDrawable().equals(R.drawable.down_23)
                && imgDown_24.getDrawable().equals(R.drawable.down_24)) return true;
        else return false;
    }
