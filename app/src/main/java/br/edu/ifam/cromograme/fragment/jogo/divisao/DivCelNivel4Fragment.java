package br.edu.ifam.cromograme.fragment.jogo.divisao;
 ...
 */
public class DivCelNivel4Fragment extends Fragment {


    public DivCelNivel4Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_div_cel_nivel4, container, false);

        TextView textView = getActivity().findViewById(R.id.textViewQuestaoDivisaoCelular);
        textView.setText("Questão: 4/10");
        radioButton = view.findViewById(R.id.rbCDivCerto4);
